...
class W_Hide_Login extends W_Core
{
    ...
    public function wp_loaded()
    {
        ...
        if (in_array(untrailingslashit($_SERVER['REQUEST_URI']), $loginPages, true)) {
            wp_safe_redirect(home_url('/404'));
            exit;
        }
    ...
    {
        echo '<div class="error notice is-dismissible"><p>' . __('Patchstack: Please upgrade to the latest version of WordPress to activate', 'webarx') . '</p></div>';
    }
